...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("h1", null, "Hello World Wide Web !!!"), /*#__PURE__*/
      React.createElement("h2", null, "Welcome to the internet TAZ xxx."), /*#__PURE__*/
      ...
      React.createElement("button", { className: "debug-button", onClick: this.handleToggleDebug }, "Debug")), /*#__PURE__*/

      React.createElement("button", { className: "trap-button", onClick: this.handleButtonClicked },
      gameOver && "Nice one",
